...
def smain(destination_host, destination_port):
    ...
    if ip != None:
        #print("[*] JARM Domain: " + destination_host)
        #print("[*] JARMResolved IP: " + ip)
        print(f"[+] JARM: {destination_host}:{destination_port}:{result}")
    else:
        #print("[*] JARM Domain: " + destination_host)
        #print("[*] JARM Resolved IP: IP failed to resolve.")
        print(f"[+] JARM: {destination_host}:{destination_port}:{result}")